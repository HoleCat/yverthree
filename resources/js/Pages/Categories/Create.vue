        ...
        <div class="py-3">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div class="p-3 bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <form @submit.prevent="store_categorie" class="flex flex-wrap">
                        ...
                        <div class="w-full mt-2 text-center">
                            <input value="AGREGAR CATEGORIA" type="submit" class="w-full bg-green-500 hover:bg-green-400 text-white font-bold mt-2 py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded"/>
                        </div>
                    </form>
...
<script>
    ...
    export default {
        ...
        methods: {
            async store_categorie() {
                let response = await this.$inertia.post('/Categories/Store', this.categorie);
            }
        }
    }
</script>
